...
export function collectGlobals() {
  ...
  return {
    ...
    dma_pct: Math.max(0, Number(val("dma_pct", "0")) || 0),
    dma_years: Math.max(0, Number(val("dma_years", "1")) || 1),
    archive_single_copy: !!fd.get("archive_single_copy")?.checked,
