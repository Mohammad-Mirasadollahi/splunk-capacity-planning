...
export const results_charts = {
  ...
  chart_lbl_summaries: "DMA (GB)",
  chart_lbl_archive: "Archive (GB)",
  chart_lbl_dma_need: "نیاز DMA (GB)",
  ...
  chart_storage_total_dma: "جمع فضای ذخیره‌سازی: {n} GB ({searchable} searchable + {dma} GB DMA)",
  chart_type: "نوع چارت",
