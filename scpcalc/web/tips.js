...
window.SCP_TIPS = {
  en: {
    ...
    cold_path_max: {
      ...
      body: "Splunk has no separate “type cold volume days” input you must invent. Cold size is the rest of the Index after homePath. SCPcalc derives coldPath.maxDataSizeMB automatically and writes it to indexes.conf — you only set Index volume (retention) and hot/warm days.",
...
const SCP_TIP_IMPACTS = {
  en: {
    ...
    cold_path_max: "You do not enter cold size. Changing retention or hot/warm days recalculates coldPath.maxDataSizeMB = maxTotal − homePath automatically.",
  ...
  fa: {
    ...
    cold_path_max: "حجم cold را وارد نمی‌کنید. با تغییر retention یا روزهای hot/warm، coldPath.maxDataSizeMB = maxTotal − homePath خودکار دوباره محاسبه می‌شود.",
...
(function localizeFa() {
  ...
  const map = {
    ...
    cold_path_max: ["coldPath.maxDataSizeMB (خودکار)", "حجم cold ورودی جدا ندارد؛ = maxTotal − homePath. SCPcalc خودش می‌نویسد."],
