...
const SCP_TIP_IMPACTS = {
  en: {
    ...
    hot_warm_days: "More hot/warm days → larger SSD/homePath budget; less stays on cold for the same total. Fewer hot/warm days → smaller fast disk, more data ages to cold sooner.",
    ...
    cold_path_max: "After Calculate, coldPath.maxDataSizeMB = maxTotal − homePath. Plan cold with cold days or cold disk GB (time↔disk pair).",
  ...
  fa: {
    ...
    hot_warm_days: "روزهای hot/warm بیشتر → بودجه SSD/homePath بزرگ‌تر؛ برای همان جمع کل کمتر روی cold می‌ماند. کمتر → دیسک سریع کوچک‌تر و داده زودتر به cold می‌رود.",
    ...
    cold_path_max: "بعد از محاسبه، coldPath.maxDataSizeMB = maxTotal − homePath. Cold را با روز cold یا GB دیسک cold (جفت زمان↔دیسک) برنامه‌ریزی کنید.",
