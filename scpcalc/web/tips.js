...
window.SCP_TIPS = {
  en: {
    ...
    archive_days: {
      ...
      formula: "Archive_Storage ≈ Daily_OnDisk × archive_days (when archive_frozen=true)",
      body: "After searchable retention ends, frozen buckets move to the archive path. This field sizes how long you plan to keep that archived copy.",
      example: "Searchable 37d + archive 90d → Retention Time bar shows Hot/Warm, Cold, then 90d Archived.",
    },
    archive_frozen: {
...
const SCP_TIP_IMPACTS = {
  en: {
    ...
    archive_days: "Longer archive days → more frozen storage to provision. Shorter → less archive disk. Only applies when Archive on freeze is on.",
  ...
  fa: {
    ...
    archive_days: "روز Archive بیشتر → دیسک آرشیو بیشتر. کمتر → فضای کمتر. فقط وقتی آرشیو هنگام Freeze روشن است.",
...
(function localizeFa() {
  ...
  const map = {
    ...
    archive_days: ["روز Archive", "بعد از freeze چند روز در مسیر آرشیو نگه دارید — برای برآورد فضای Archived."],
