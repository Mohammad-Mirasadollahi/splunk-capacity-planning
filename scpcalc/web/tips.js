...
const SCP_TIP_IMPACTS = {
  en: {
    ...
    "summaries need GB": "Grows with dma_years (ES ×3.4/year) or dma_pct override — not index retention_days unless using override mode.",
  ...
  fa: {
    ...
    "summaries need GB": "با dma_years (ES ×۳٫۴/year) یا override dma_pct زیاد می‌شود — نه retention ایندکس مگر حالت override.",
